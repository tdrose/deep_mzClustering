...
class Clustering(object):
    def __init__(self, spec_path, label_path=None, num_cluster=7, height=40, width=40, lr=0.0001,
        ...
        # Todo: Adapt to 2d input directly
    ...
    def train(self):
        ...
        clust = cnnClust(num_clust=self.num_cluster).to(self.device)
        ...
        for epoch in range(0, 11):
            ...
            for it in range(501):
                ...
                train_x, train_y, index = self.get_batch(self.image_data, self.image_label, self.batch_size)
                # Todo: adapt to 2d input directly
        ...
        for epoch in range(0, 11):
            ...
            for it in range(31):
                ...
                train_x, train_y, index = self.get_batch(self.image_data, self.image_label, self.sampleN)
                ...
                # What it should do:
                # 1. compute A' -> 1 if sim>=ub, 0 if sim<=lb
                ...
                pos_loc, neg_loc = pseudo_labeling(features, ub, lb, index=index, KNN=True, A=sim_numpy)
